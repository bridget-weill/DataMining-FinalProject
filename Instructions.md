...
### Submission Rules
- Only __one (1)__ final submission can be made.
...
- Submissions are ranked base on F1-score and AUC, respectively. Performances are ranked - the  top 3 ranked in class are rewarded with extra points: 
...
- Extra point opportunities: can use up to __TWO (2)__ extra points opportunities – each opportunity worth up to 10 extra points:
